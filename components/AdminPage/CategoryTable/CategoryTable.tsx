...
export default function PackageTable() {
  ...
  const { isLoading, error, data } = useQuery("ฉategoryDetail", () =>
    Axios.get(`/administrator/learning-lesson/category/all`, {
      headers: {
  ...
  function deletePackage(id: any) {
    Axios.delete(`/administrator/learning-lesson/category/${id}/delete`, {
      headers: {
        Authorization: `Bearer ${auth.token}`,
      },
    });
  ...
  function editPackage() {
    ...
    if (result.success) {
      Axios.patch(
        `/administrator/learning-lesson/category/${items.id}/update`,
        {
          name: name,
        },
        {
