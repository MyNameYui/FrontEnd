...
import Add from "../../modal/package/add";
...
export default function PackageTable() {
  ...
  const { isLoading, error, data } = useQuery("PackageDetail", () =>
    Axios.get(`/administrator/learning-package/all`, {
      headers: {
  ...
  function deletePackage(id: any) {
    Axios.delete(`/administrator/learning-package/${id}/delete`, {
      headers: {
        Authorization: `Bearer ${auth.token}`,
      },
    });
          ...
          <ModalContent>
            {(onClose) => (
              <>
                ...
                <ModalBody>
                  <p className="text-xl">แน่ใจหรือไหมที่คุณจะลบ</p>
                </ModalBody>
                <ModalFooter>
